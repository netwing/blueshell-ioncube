...
<tr>
	...
	<td>
		<form action="statistiche2.php" method="post" name="form1">
		<table width="100%" border="0">
			...
			<tr>
				<td>Statistiche sulle Presenze per Dimensioni Risorsa, dell'anno {$anno}</td>
			</tr>
			<tr>
				<td>
				<table border="0">
                	<tr>
                		<td><strong>Dimensioni P.B.</strong></td>
				...
				{foreach from=$stat item=i}					
                	<tr>
                		<td><strong>{$i.dimensioni}</strong></td>
