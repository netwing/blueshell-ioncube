...
<tr>
	...
	<td>
		<form action="statistiche3.php" method="post" name="form1">
		<table width="100%" border="0">
			...
			<tr>
				<td>Statistiche sulle Presenze per Tipologia di Imbarcazione, dell'anno {$anno}</td>
			</tr>
			<tr>
				<td>
				<table border="0">
                	<tr>
                		<td><strong>Tipologia di Imbarcazione</strong></td>
				...
				{foreach from=$stat item=i}					
                	<tr>
                		<td><strong>{$i.tipologia}</strong></td>
